...
aa_pi <- as.matrix(read.csv("../inst/extdata/amino_acid_equilibrium.csv"))
```
...
The component models explicitly use the dS gauge. Branch lengths therefore
measure neutral nucleotide substitutions per site rather than synonymous
events per codon.
...
Synonymous substitutions are shown in green, non-synonymous in red. Switches between models shown in blue.
