...
Both fitness profiles use the same mutation-based dS clock. The tree is
therefore measured in neutral nucleotide substitutions per site while switch
times remain site specific.
