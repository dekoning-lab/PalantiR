...
Both models use the same mutation-based dS clock. The supplied branch lengths
therefore remain neutral nucleotide substitutions per site through the
population-size shift; the transient rescaler integrates that clock under the
inherited codon distribution.
