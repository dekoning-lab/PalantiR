...
GeneticCode <- function() {
    .Call('_PalantiR_GeneticCode', PACKAGE = 'PalantiR')
}
...
simulate_over_interval_phylogeny <- function(phylogeny, mode_phylogeny, models, sequence, start_mode, rate = 1, segment_length = 0.001, tolerance = 0.001, rescale_method = "exact", scaling_targets = NULL) {
    .Call('_PalantiR_simulate_over_interval_phylogeny', PACKAGE = 'PalantiR', phylogeny, mode_phylogeny, models, sequence, start_mode, rate, segment_length, tolerance, rescale_method, scaling_targets)
}
